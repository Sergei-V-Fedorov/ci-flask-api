...
async def insert_data():
    ...
    recipe_2 = models.Recipe(
        ...
        description='Разогрейте сковороду. Налейте немного растительного масла'
                    ' и выложите порезанную колбасу. Обжарить колбасу с двух сторон.'
                    'Вбейте яйца. Рядом разложите помидоры.'
                    'Посолить по вкусу.',
    )

    recipe_1.components = [component_2, component_1, component_3]

    recipe_2.components = [component_2, component_1, component_3,
                           component_4, component_5]
